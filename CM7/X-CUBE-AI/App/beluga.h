...
#include "beluga_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_BELUGA_MODEL_NAME          "beluga"
#define AI_BELUGA_ORIGIN_MODEL_NAME   "quantized_model"

/******************************************************************************/
#define AI_BELUGA_ACTIVATIONS_ALIGNMENT   (4)
#define AI_BELUGA_INPUTS_IN_ACTIVATIONS   (4)
#define AI_BELUGA_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_BELUGA_IN_NUM        (1)

AI_DEPRECATED
#define AI_BELUGA_IN \
  ai_beluga_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_BELUGA_IN_SIZE { \
  AI_BELUGA_IN_1_SIZE, \
}
#define AI_BELUGA_IN_SIZE_BYTES { \
  AI_BELUGA_IN_1_SIZE_BYTES, \
}
#define AI_BELUGA_IN_1_FORMAT      AI_BUFFER_FORMAT_U8
#define AI_BELUGA_IN_1_HEIGHT      (96)
#define AI_BELUGA_IN_1_WIDTH       (96)
#define AI_BELUGA_IN_1_CHANNEL     (3)
#define AI_BELUGA_IN_1_SIZE        (96 * 96 * 3)
#define AI_BELUGA_IN_1_SIZE_BYTES  (27648)

/******************************************************************************/
#define AI_BELUGA_OUT_NUM       (1)

AI_DEPRECATED
#define AI_BELUGA_OUT \
  ai_beluga_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_BELUGA_OUT_SIZE { \
  AI_BELUGA_OUT_1_SIZE, \
}
#define AI_BELUGA_OUT_SIZE_BYTES { \
  AI_BELUGA_OUT_1_SIZE_BYTES, \
}
#define AI_BELUGA_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_BELUGA_OUT_1_CHANNEL     (3)
#define AI_BELUGA_OUT_1_SIZE        (3)
#define AI_BELUGA_OUT_1_SIZE_BYTES  (12)

/******************************************************************************/
#define AI_BELUGA_N_NODES (45)
 ...
 * @ref ai_beluga_create. Both the activations memory buffer 
 ...
 */
AI_API_ENTRY
ai_buffer* ai_beluga_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_beluga_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_BELUGA_*
 * defines into file @ref beluga.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
